...
func MigrateDB() {
	...
	err := DB.AutoMigrate(
		...
		// 2. Tabel yang bergantung pada Sekolah
		&models.Hari{},
		&models.Kelas{},

		// 3. Tabel yang bergantung pada Kelas & Sekolah
		&models.SchoolMember{},

		// 4. Tabel User bergantung pada School Member
		&models.User{},

		// 5. Tabel Transaksi / Fitur bergantung pada User
		&models.FaceRegistration{},
		&models.Presence{},
		&models.LateEntry{},
		&models.LeaveDocument{},
		&models.Setting{},
		&models.SPRecord{},
	)
