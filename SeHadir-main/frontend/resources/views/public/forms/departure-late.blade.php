...
@section('title', "Late attendance form for today's departure")
    ...
    <div
        ...
        <div class="w-full max-w-md mx-auto">
            ...
            <div
                ...
                <div class="bg-linear-to-r from-indigo-500 to-purple-600 px-6 py-5 text-center">
                    ...
                    <p class="text-indigo-100 text-sm mt-1">Isi alasan keterlambatan pulang Anda</p>
                </div>

                <!-- Form Body -->
                <div class="p-6 sm:p-8">
                    <form action="{{ route('forms.late.submit_departure') }}" method="POST" class="space-y-5">
                        @csrf
                        ...
                        <div class="group">
                            <label
                                class="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                                <i class="fa-regular fa-id-card text-indigo-500"></i>
                                No Induk
                            </label>
                            <div class="relative">
                        ...
                        <div class="group">
                            <label
                                class="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                                <i class="fa-regular fa-message text-indigo-500"></i>
                                Alasan Telat Pulang <span class="text-red-500 text-xs">*</span>
                            </label>
                            <div class="relative">
                                <textarea name="alasan" rows="4"
                                    class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all resize-none"
                                    placeholder="Contoh: Ada kegiatan tambahan, kendala teknis, dll..."></textarea>
