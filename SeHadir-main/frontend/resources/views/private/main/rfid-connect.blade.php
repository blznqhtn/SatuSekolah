                                    ...
                                    <div
                                        ...
                                        <div class="flex-1">
                                            <div class="flex justify-between">
                                                <h3 class="font-medium account-name">{{ $akunku->school_member->name }}
                                                </h3>
                                                <span
                                                    class="text-sm text-gray-500 dark:text-gray-400 account-class">{{ $akunku->school_member->kelas }}</span>
                                            </div>
