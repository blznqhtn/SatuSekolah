    ...
    <div id="akun-siswa" class="tab-content">
        <form method="GET" action="{{ route('admin.accounts.index') }}"
            ...
            <div class="flex w-full md:w-auto mb-4 md:mb-0">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari akun siswa..."
                ...
                <div class="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
                    <select name="kelas" onchange="this.form.submit()"
                        ...
                        @foreach (['X RPL 1', 'X RPL 2', 'X RPL 3', 'X RPL 4', 'XI RPL 1', 'XI RPL 2', 'XI RPL 3', 'XI RPL 4', 'XII RPL 1', 'XII RPL 2', 'XII RPL 3', 'XII RPL 4', 'X DKV 1', 'X DKV 2', 'X DKV 3', 'XI DKV 1', 'XI DKV 2', 'XI DKV 3', 'XII DKV 1', 'XII DKV 2', 'XII DKV 3', 'X TKJ 1', 'X TKJ 2', 'X TKJ 3', 'XI TKJ 1', 'XI TKJ 2', 'XI TKJ 3', 'XII TKJ 1', 'XII TKJ 2', 'XII TKJ 3', 'X TRANSMISI', 'XI TRANSMISI', 'XII TRANSMISI'] as $kelasOption2)
                            <option value="{{ $kelasOption2 }}" {{ request('kelas') == $kelasOption2 ? 'selected' : '' }}>
                                {{ $kelasOption2 }}</option>
                        @endforeach
                    </select>
                </div>
                            ...
                            @foreach ($akunSiswa as $akunku)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td
                                        ...
                                        {{ $akunku->school_member->name }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                        {{ $akunku->school_member->kelas }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                    ...
                                    <td>
                                        <div class="max-w-full flex flex-row justify-start items-center">
                                            @if ($akunku->status_ban == 'active')
                                                <div data-idAkun="{{ $akunku->id }}" data-namaAkun="{{ $akunku->school_member->name }}" title="Non-Aktifkan Akun Siswa" class="btnBan">
                                            ...
                                            @else
                                                <div data-idAkun="{{ $akunku->id }}" data-namaAkun="{{ $akunku->school_member->name }}" title="Aktifkan Akun Siswa" class="btnActive">
                                            ...
                                            <div data-emailAkun="{{ $akunku->email }}" data-namaAkun="{{ $akunku->school_member->name }}" title="Reset Password Akun Siswa" class="btnResetPw">
