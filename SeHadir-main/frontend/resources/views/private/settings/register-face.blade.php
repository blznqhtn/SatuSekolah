                    ...
                    <div class="lg:col-span-2 bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    <button id="studentSelectBtn" type="button"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-left flex items-center justify-between">
                            ...
                            <div id="studentModal"
                                ...
                                <div
                                    class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4 max-h-96 flex flex-col">
                                    ...
                                    <div class="flex-1 overflow-y-auto p-2">
                                        <div id="studentList" class="space-y-1">
                                            @foreach ($students as $student)
                                                <div class="student-item p-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg cursor-pointer border border-transparent hover:border-primary-300"
                                                    data-nis="{{ $student->nis }}" data-name="{{ $student->name }}">
                                                    <div class="flex items-center">
                                                        <div
                                                            class="w-10 h-10 bg-primary-100 dark:bg-primary-900 rounded-full flex items-center justify-center mr-3">
                                                            <i
                                                                class="fas fa-user text-primary-600 dark:text-primary-400"></i>
                                                        </div>
                                                        <div>
                                                            <div class="font-medium text-gray-900 dark:text-white">
                                                                {{ $student->name }}</div>
                                                            <div class="text-sm text-gray-500 dark:text-gray-400">NIS:
                                                                {{ $student->nis }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div id="captureInstructions"
                                class="mb-4 p-4 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg hidden">
                                <div class="text-center">
                                    ...
                                    <div id="captureStatus"
                                        class="mt-3 text-lg font-bold text-green-600 dark:text-green-300">
                                        Foto: 0/9
                                    </div>
                            ...
                            <div class="relative bg-gray-900 rounded-lg overflow-hidden mb-6 w-full"
                                style="height: 480px; max-width: 480px; margin: 0 auto;">
                                    ...
                                    <div id="faceRing" class="relative" style="width: 280px; height: 350px;">
                                        ...
                                        <svg class="absolute inset-0 w-full h-full" viewBox="0 0 280 350">
                                            <ellipse cx="140" cy="175" rx="130" ry="165"
                                                fill="none" stroke="#10b981" stroke-width="4" stroke-dasharray="10,5"
                            ...
                            <div class="space-y-4">
                                <button id="startCamera"
                                    class="w-full bg-primary-600 hover:bg-primary-700 text-white font-medium py-3 px-6 rounded-lg transition duration-200 flex items-center justify-center"
                                    disabled>
                                    <i class="fas fa-camera mr-2"></i>Mulai Registrasi Wajah
                                </button>

                                <div id="livenessStatus"
                                    class="w-full bg-blue-600 text-white font-medium py-3 px-6 rounded-lg flex items-center justify-center hidden">
                                    <i class="fas fa-eye mr-2"></i><span id="livenessText">Liveness Detection
                                        Aktif</span>
                                </div>

                                <button id="registerBtn"
                                    class="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-6 rounded-lg transition duration-200 flex items-center justify-center hidden"
                                    disabled>
                                    <i class="fas fa-user-check mr-2"></i>Daftar Face ID
                                </button>

                                <button id="resetBtn"
                                    class="w-full bg-gray-600 hover:bg-gray-700 text-white font-medium py-3 px-6 rounded-lg transition duration-200 flex items-center justify-center hidden">
                                    <i class="fas fa-redo mr-2"></i>Ulangi
                                </button>

                                <button id="stopCamera"
                                    class="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-6 rounded-lg transition duration-200 flex items-center justify-center hidden">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            <div id="photoPreview" class="grid grid-cols-3 gap-2">
                                ...
                                <div
                                    class="aspect-square bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center text-xs">
                ...
                class FaceRegistrationSystem {
                            ...
                            if (this.isModelLoaded && this.video.videoWidth > 0) {
                                ...
                                if (detection) {
                                    ...
                                    if (faceInPosition) {
                                        ...
                                        this.captureMessage.className =
                                            'mt-2 text-sm text-green-600 dark:text-green-400 font-bold';
                                    } else if (isCentered) {
                                        this.ringStroke.setAttribute('stroke', '#f59e0b'); // Orange
                                        this.ringStroke.setAttribute('stroke-width', '4');
                                        this.captureMessage.textContent = isGoodSize ? 'Posisikan lebih dekat/jauh' :
                                            'Atur jarak kamera';
                    ...
                    manualBlink() {
                        ...
                        if (this.livenessPhase === 'blink') {
                            ...
                            if (this.blinkCount >= this.requiredBlinks) {
                                ...
                                setTimeout(() => {
                                    this.instructionTimer.textContent =
                                        `Butuh ${this.requiredBlinks - this.blinkCount} kedipan lagi`;
                                }, 1000);
                            }
                        }
                    }
                    ...
                    manualHeadTurn(direction) {
                        if (direction === 'right' && this.livenessPhase === 'look_right' && !this.requiredHeadTurns.right) {
                            ...
                            setTimeout(() => {
                                if (this.instructionTimer) this.instructionTimer.textContent =
                    ...
                    updatePhaseUI() {
                        ...
                        // Reset all phases
                        phase1.querySelector('div').className =
                            'w-8 h-8 rounded-full bg-gray-300 text-gray-600 flex items-center justify-center text-sm font-bold';
                        phase1.querySelector('span').className = 'text-sm text-gray-500';
                        phase2.querySelector('div').className =
                            'w-8 h-8 rounded-full bg-gray-300 text-gray-600 flex items-center justify-center text-sm font-bold';
                        phase2.querySelector('span').className = 'text-sm text-gray-500';
                        phase3.querySelector('div').className =
                            'w-8 h-8 rounded-full bg-gray-300 text-gray-600 flex items-center justify-center text-sm font-bold';
                        ...
                        switch (this.livenessPhase) {
                            case 'blink':
                                phase1.querySelector('div').className =
                                    'w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-bold';
                    ...
                    processMediaPipeResults(results) {
                        ...
                        console.log(
                            `🔍 Current Phase: ${this.livenessPhase}, Blinks: ${this.blinkCount}/${this.requiredBlinks}, Right: ${this.requiredHeadTurns.right}, Left: ${this.requiredHeadTurns.left}`
                            );
                        ...
                        switch (this.livenessPhase) {
                            case 'blink':
                                ...
                                if (this.blinkCount >= this.requiredBlinks) {
                                    console.log(
                                        '🎯 Blink phase completed, but staying in blink phase until timeout or manual advance'
                                        );
                                }
                                break;
                            case 'look_right':
                        ...
                        if (this.livenessPhase === 'look_left' && this.blinkCount >= this.requiredBlinks && this
                            .requiredHeadTurns.right && this.requiredHeadTurns.left) {
                            this.checkLivenessCompletion();
                        }
                    }
                    ...
                    detectMediaPipeBlink(landmarks) {
                        try {
                            ...
                            console.log(
                                `👁️ MediaPipe EAR: ${avgEAR.toFixed(3)}, Left: ${leftEAR.toFixed(3)}, Right: ${rightEAR.toFixed(3)}`
                                );
                            ...
                            if (this.mediaBlinkState.leftEyeHistory.length >= 5) {
                                const avgLeftEAR = this.mediaBlinkState.leftEyeHistory.reduce((a, b) => a + b, 0) / this
                                    .mediaBlinkState.leftEyeHistory.length;
                                const avgRightEAR = this.mediaBlinkState.rightEyeHistory.reduce((a, b) => a + b, 0) / this
                                    .mediaBlinkState.rightEyeHistory.length;
                                ...
                                console.log(
                                    `🎯 MediaPipe Baseline: ${baseline.toFixed(3)}, Threshold: ${blinkThreshold.toFixed(3)}, Blinking: ${isCurrentlyBlinking}`
                                    );
                                ...
                                if (isCurrentlyBlinking && !this.mediaBlinkState.isBlinking) {
                                    ...
                                    if (blinkDuration > 30 && blinkDuration < 1500 && this.mediaBlinkState
                                        .framesSinceLastBlink > 3) {
                                        this.blinkCount++;
                                        this.mediaBlinkState.framesSinceLastBlink = 0;
                                        console.log(
                                            `✅ MediaPipe Blink #${this.blinkCount} detected! Duration: ${blinkDuration}ms`);

                                        this.updateBlinkUI();
                                        if (this.instructionTimer) this.instructionTimer.textContent =
                                            `✅ Kedipan ${this.blinkCount} berhasil!`;
                                        ...
                                        if (this.blinkCount >= this.requiredBlinks && this.livenessPhase === 'blink') {
                                            ...
                                            if (this.instructionTimer) this.instructionTimer.textContent =
                                                '✅ Kedipan selesai! Bersiap untuk tengok kiri...';
                                            ...
                                            setTimeout(() => {
                                                ...
                                                if (this.livenessPhase === 'blink' && this.blinkCount >= this
                                                    .requiredBlinks) {
                                                    this.livenessPhase = 'look_right';
                                                    this.phaseStartTime = Date.now();
                                                    this.updatePhaseUI();
                                                    if (this.manualBlinkBtn) this.manualBlinkBtn.classList.add(
                                                    'hidden');
                                                    if (this.instructionTimer) this.instructionTimer.textContent =
                                                        'Sekarang tengok ke KIRI (akan terlihat kanan di kamera)';
                                ...
                                if (!this.mediaBlinkState.isBlinking && this.mediaBlinkState.framesSinceLastBlink > 10) {
                                    ...
                                    if (isStrongBlink) {
                                        ...
                                        this.mediaBlinkState.framesSinceLastBlink = 0;
                                        console.log(
                                            `✅ MediaPipe Strong Blink #${this.blinkCount} detected! EAR: ${avgEAR.toFixed(3)}`
                                            );
                                ...
                                // Update instruction
                                if (this.livenessPhase === 'blink' && !isCurrentlyBlinking && this.blinkCount < this
                                    .requiredBlinks) {
                                    if (this.instructionTimer && !this.instructionTimer.textContent.includes('✅') && !this
                                        .instructionTimer.textContent.includes('Butuh')) {
                    ...
                    detectMediaPipeHeadPose(landmarks, direction) {
                        try {
                            ...
                            const leftCheekDistance = Math.sqrt(Math.pow(leftCheek.x - faceCenterX, 2) + Math.pow(leftCheek.y -
                                faceCenterY, 2));
                            const rightCheekDistance = Math.sqrt(Math.pow(rightCheek.x - faceCenterX, 2) + Math.pow(rightCheek
                                .y - faceCenterY, 2));
                            ...
                            console.log(
                                `🎯 MediaPipe Head Pose - Direction: ${direction}, Combined Ratio: ${combinedRatio.toFixed(3)}, Nose Offset: ${headTurnRatio.toFixed(3)}, Cheek Ratio: ${cheekRatio.toFixed(3)}`
                                );
                            ...
                            if (direction === 'right' && combinedRatio < -0.15) { // User tengok kiri = kanan di kamera
                                ...
                                setTimeout(() => {
                                    if (this.instructionTimer) this.instructionTimer.textContent =
                                        'Sekarang tengok ke KANAN (akan terlihat kiri di kamera)';
                                }, 1000);
                            ...
                            if (phaseTime > 8000) { // 8 seconds timeout
                                if (direction === 'right' && !this.requiredHeadTurns.right) {
                                    ...
                                    this.updatePhaseUI();
                                    if (this.instructionTimer) this.instructionTimer.textContent =
                                        'Timeout - Tengok ke KANAN (kiri di kamera)';
                                } else if (direction === 'left' && !this.requiredHeadTurns.left) {
                    ...
                    checkBlinkDetection(landmarks) {
                        ...
                        console.log(
                        `👁️ EAR: ${avgEAR.toFixed(3)}, Left: ${leftEAR.toFixed(3)}, Right: ${rightEAR.toFixed(3)}`);
                        ...
                        if (this.blinkDetectionState.earHistory.length >= 10) {
                            this.blinkDetectionState.openEyeBaseline = this.blinkDetectionState.earHistory.reduce((a, b) => a +
                                b, 0) / this.blinkDetectionState.earHistory.length;
                        }
                        ...
                        if (this.blinkDetectionState.earHistory.length >= 5) {
                            ...
                            console.log(
                                `🎯 Avg: ${avgEARRecent.toFixed(3)}, Threshold: ${blinkThreshold.toFixed(3)}, Strong: ${strongBlinkThreshold.toFixed(3)}, Current: ${avgEAR.toFixed(3)}, Blinking: ${isCurrentlyBlinking}, Strong: ${isStrongBlink}`
                                );
                            ...
                            if (isCurrentlyBlinking && !this.blinkDetectionState.isBlinking) {
                                ...
                                // More lenient blink validation
                                if (blinkDuration > 50 && blinkDuration < 1000 && this.blinkDetectionState
                                    .framesSinceLastBlink > 5) {
                                    this.blinkCount++;
                                    this.blinkDetectionState.framesSinceLastBlink = 0;
                            ...
                            if (this.blinkDetectionState.earHistory.length >= 3 && this.blinkDetectionState
                                .framesSinceLastBlink > 10) {
                                ...
                                if (earChange1 > 0.05 || earChange2 > 0.05) {
                                    ...
                                    this.blinkDetectionState.framesSinceLastBlink = 0;
                                    console.log(
                                        `✅ Spike blink #${this.blinkCount} detected! Changes: ${earChange1.toFixed(3)}, ${earChange2.toFixed(3)}`
                                        );
                    ...
                    checkHeadPose(landmarks, direction) {
                        ...
                        console.log(
                            `Head pose - Direction: ${direction}, Combined Ratio: ${combinedRatio.toFixed(3)}, Eye Distance: ${eyeDistanceRatio.toFixed(3)}`
                            );
                    ...
                    finalizePhotosAndAutoRegister() {
                        ...
                        this.livenessText.textContent =
                            `✅ ${this.capturedPhotos.length} foto berhasil diambil - Menyimpan ke database...`;
                    ...
                    async autoRegisterFace() {
                        try {
                            ...
                            this.showAutoRegistrationError({
                    ...
                    showAutoRegistrationSuccess(result) {
                        ...
                        studentItems.forEach(item => {
                            if (item.dataset.nis === registeredNIS) {
                                item.remove();
                                console.log(
                                    `✅ Removed student ${result.student_name} (NIS: ${registeredNIS}) from dropdown`
                                    );
                            }
                        });
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    document.querySelectorAll('.student-item').forEach(item => {
                        item.addEventListener('click', function() {
                            ...
                            // Clear search
                            studentSearch.value = '';
                            document.querySelectorAll('.student-item').forEach(i => i.style.display =
                                'block');
                        });
                    });
