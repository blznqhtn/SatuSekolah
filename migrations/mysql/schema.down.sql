...
ALTER TABLE canteen_orders DROP COLUMN IF EXISTS payment_method;
ALTER TABLE canteen_orders DROP COLUMN IF EXISTS dynamic_qr_code;
ALTER TABLE canteen_orders DROP COLUMN IF EXISTS rfid_payment_code;
ALTER TABLE canteen_orders DROP COLUMN IF EXISTS transfer_target_account;
ALTER TABLE canteen_orders DROP COLUMN IF EXISTS expires_at;
